...
public class AddRecipe extends AppCompatActivity {
    ...
    TextInputLayout r_title, r_ingredients, r_step1, r_step2, r_step3, r_step4, r_step5, r_instructions;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_recipe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RecipeHelperClass helperClass2 = new RecipeHelperClass(title, ingredients, step1, step2, step3, step4, step5, instructions);
